...
class ASTFactory(val location: ComplexSymbolFactory.Location) {
    ...
    fun binop(op: BinOpExprNode.BinopType, left: ExprNode, right: ExprNode) = BinOpExprNode(location, op, left, right)
    fun add(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.ADD, left, right)
    fun sub(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.SUB, left, right)
    fun mul(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.MUL, left, right)
    fun div(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.DIV, left, right)
    fun rem(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.REM, left, right)
    fun highMul(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.HIGH_MUL, left, right)
    fun and(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.AND, left, right)
    fun or(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.OR, left, right)
    fun gte(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.GTE, left, right)
    fun gt(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.GT, left, right)
    fun lte(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.LTE, left, right)
    fun lt(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.LT, left, right)
    fun eq(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.EQ, left, right)
    fun neq(left: ExprNode, right: ExprNode) = binop(BinOpExprNode.BinopType.NEQ, left, right)
